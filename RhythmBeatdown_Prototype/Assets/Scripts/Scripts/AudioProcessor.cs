...
public class AudioProcessor : MonoBehaviour {
	...
	public static float cresTimeScale = 1.0f;

	public MultiMusicPlayer mmplayer;
...
//		{
//			pause (); //Manual slow down for testing crescendo timing
//		}
	}
	public void pause(){
		print ("pause");
	...
	public IEnumerator pausing(){
		...
		for (float t = 0; t <= 1; t += (Time.deltaTime)) {
			cresTimeScale = Mathf.Lerp (1.0f, 0.5f, t);
			print (cresTimeScale);
			mmplayer.Pitch = cresTimeScale;
			Time.timeScale = cresTimeScale;

			musicClip.pitch = cresTimeScale;
			yield return new WaitForSeconds (0);
		}
		yield return new WaitForSecondsRealtime (1);
		for (float t = 0; t <= 1; t += (Time.deltaTime)) {
			cresTimeScale = Mathf.Lerp (0.5f, 1.0f, t);
			Time.timeScale = cresTimeScale;
			mmplayer.Pitch = cresTimeScale;
			musicClip.pitch = cresTimeScale;
			yield return new WaitForSeconds (0);
